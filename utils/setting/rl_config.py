...
class AlgorithmParameters:
    ...
    def __init__(self, gpt_seq_length=16, discount_factor=0.99, advantage_lambda=0.95, use_deterministic=False, use_masked_exploration=True):
...
class OptimizationParameters:
    ...
    def __init__(self, lr=1e-4, min_lr=5e-5, scheduler_type='exponential', tau=1e-1, use_target_network=True, clip_grad_range=None, max_grad_norm=None): 
