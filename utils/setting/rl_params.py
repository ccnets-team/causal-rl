...
class TrainingParameters:
    def __init__(self, batch_size=512, replay_ratio=3, train_frequency=2):
...
class AlgorithmParameters:
    def __init__(self, num_td_steps=4, discount_factor=0.99, curiosity_factor = 0.0, use_gae_advantage = False):
