...
def load_trainer(trainer, save_path):
    ...
    return_normalizer = trainer.get_return_normalizer() 
    ...
    if return_normalizer is not None:
        return_normalizer.load(save_path + f"return_normalizer" + '.pth')
...
def save_trainer(trainer, save_path):
    ...
    if return_normalizer is not None:
        return_normalizer.save(os.path.join(save_path, f"return_normalizer" + '.pth'))
