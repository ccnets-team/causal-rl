...
from .trainer_utils import calculate_lambda_returns, masked_tensor_reduction, calculate_normalized_sum_reward_scale
...
class BaseTrainer(TrainingManager, NormalizationUtils, ExplorationUtils):
    def __init__(self, env_config: EnvConfig, rl_params: RLParameters, networks, target_networks, device):
        ...
        self.normalized_sum_reward_scale = calculate_normalized_sum_reward_scale(self.discount_factor, self.advantage_lambda, self.gpt_seq_length, self.device)
    ...
    def compute_values(self, trajectory: BatchTrajectory, estimated_value: torch.Tensor, padding_mask: torch.Tensor):
        ...
        with torch.no_grad():
            ...
            normalized_sum_rewards = self.normalize_sum_rewards(sum_rewards, padding_mask, self.normalized_sum_reward_scale)
