...
class StrategyManager(NormalizationUtils, ExplorationUtils):
    def __init__(self, env_config, algorithm_params, exploration_params, normalization_params, device):  
        NormalizationUtils.__init__(self, env_config, algorithm_params, normalization_params, device)
