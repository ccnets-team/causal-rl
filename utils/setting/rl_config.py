...
class TrainingParameters:
    ...
    def __init__(self, batch_size=64, replay_ratio=1, train_interval=1, max_steps=150000, buffer_size=384000):
...
class AlgorithmParameters:
    ...
    def __init__(self, gpt_seq_length=16, discount_factor=0.995, advantage_lambda=0.90, use_deterministic=False, use_masked_exploration=True):
...
class OptimizationParameters:
    ...
    def __init__(self, lr=1e-4, min_lr=1e-5, scheduler_type='exponential', tau=1e-1, use_target_network=True, clip_grad_range=None, max_grad_norm=1.0): 
